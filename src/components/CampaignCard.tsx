      ...
      <div className="p-5">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-sm mb-1">
            <span className="font-semibold text-patriot-blue">{formatIndianRupee(campaign.raised)}</span>
            <span className="text-gray-500">raised of {formatIndianRupee(campaign.goal)}</span>
          </div>
